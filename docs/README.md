...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
	    ...
	    <tr>
	      <td>jenkins</td>
	      <td title='Jenkins - Build great things at any scale! As the leading open source automation server, Jenkins provides over 1800 plugins to support building, deploying and automating any project. '><a href='https://www.jenkins.io/'> <img src='https://get.jenkins.io/art/jenkins-logo/logo.svg' width='24px' height='24px'> jenkins</a></td>
	      <td>5.1.26</td>
